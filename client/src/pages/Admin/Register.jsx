    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-20">
      <div className="max-w-md w-full rounded-[32px] shadow-extruded p-10 bg-neo-bg">
        <div className="text-center mb-10">
          <h2 className="text-4xl font-extrabold font-display text-neo-fg">Admin Register</h2>
          <p className="text-neo-muted mt-3 font-medium">Create a master account</p>
        </div>
        ...
        <div className="mt-8 text-center text-sm text-neo-muted font-bold space-y-4">
          <div><Link to="/admin/login" className="hover:text-neo-accent transition-colors">Already have an account? Login</Link></div>
        </div>
      </div>
    </div>
  );
